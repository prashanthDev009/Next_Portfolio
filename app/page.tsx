...
export default function Home() {
  return (
    ...
    <main className='w-screen h-screen relative'>
      ...
      {/* Creating a same buttons below for more responsive on portraits mobile version */}
      ...
      <div className='absolute flex bottom-10 z-[20] right-5 flex-col md:hidden gap-5'>
            ...
            <Link href="/contact-me" className='rounded-[20px] group relative bg-trasparent px-5 border border-white py-3 text-lg text-white max-w-[200px]'>       
              <div className='absolute rounded-[20px] z-[1] bg-white inset-0 opacity-0' />
              Contact me
            </Link>
      </div> 
